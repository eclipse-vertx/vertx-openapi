...
public class BaseValidator {
  ...
  public boolean isSchemaValidationRequired(MediaType mediaType) {
  ...
  protected RequestParameterImpl validate(MediaType mediaType, Buffer rawContent, ValidationContext requestOrResponse) {
    ContentAnalyser contentAnalyser = mediaType == null ? null :
      ContentAnalyser.getContentAnalyser(mediaType.getIdentifier(), rawContent, requestOrResponse);
